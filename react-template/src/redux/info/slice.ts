...
export const selectErrors = (state: AppState): Record<string, ApiError> =>
  state.info && state.info?.errors;
export const selectErrorBanner = (state: AppState): string | undefined =>
  state.info && state.info?.banner;
export const selectMessages = (state: AppState): InfoMessage[] =>
  state.info && state.info?.messages;
export const selectAuthState = (state: AppState): string | undefined =>
